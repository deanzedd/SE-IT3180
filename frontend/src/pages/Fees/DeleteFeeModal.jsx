...
const DeleteFeeModal = ({ isOpen, onClose, onSubmit }) => {
            ...
            <div className="p-1">
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex gap-10 pt-4 border-t border-gray-100">
                        <div className="">
                            <h2 className="text-2xl text-gray-800">Bạn có chắn chắn muốn xóa khoản thu này</h2>
                        </div>
                        //Xuống dòng kiểu gì?
                        <div>
                            <Button
                            ...
                            <Button
                                type="submit"
                                className="flex-auto bg-linear-to-r from-orange-700 to-red-900 text-black font-bold transition-colors"
                            >
                                Xóa
                            </Button>
                        </div>
...
export default TestDeleteFeeModal;